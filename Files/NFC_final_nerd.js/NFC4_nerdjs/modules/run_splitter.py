...
from NFC4_nerdjs.modules.multidocs import multi
from NFC4_nerdjs.modules.RAG import rag_main



output_path = "C:\\Users\\Nitesh\\NFC_final_nerd.js\\NFC4_nerdjs\\database\\sample_json.json"
...
def main(name):
    FILE_PATH = os.path.join("C:\\Users\\Nitesh\\NFC_final_nerd.js\\NFC4_nerdjs\\database", name)
    ...
    if chunk_keypoints and stats:
        ...
        json_path = "C:\\Users\\Nitesh\\NFC_final_nerd.js\\NFC4_nerdjs\\database\\sample_json.json"
        ...
        if GENERATE_PDF_SUMMARY:
            ...
            with open(f"C:\\Users\\Nitesh\\NFC_final_nerd.js\\NFC4_nerdjs\\database\\{base_name}_summary.txt", "w", encoding="utf-8") as f:
                f.write(summary)
            print(f"\n📝 Summary:\n\n{summary}\n")
